...
const KIND_HINTS: Record<MessageTemplateKind, string> = {
  ...
  payment_reminder: "Напоминание оплатить бронь — отправляется автоматически, когда у пользователя остаётся менее 25% времени. Доступны: {full_name}, {items}, {amount}, {booking_link}, {expires_at}, {minutes_left} — сколько минут осталось, {movie}, {starts_at}, {rooftop}.",
